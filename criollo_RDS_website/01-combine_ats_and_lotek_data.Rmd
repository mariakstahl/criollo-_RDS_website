...
## Description
This code creates a database file called cattle.db and populates it with all my various .csv files. As it is now, this chapter has no narration between code chunks but I intend to go back and fill in some of the details later.
