...
* Cow bread and ear tag ID
* Beef metrics (including weights and body condition scores)
* Diet sample data
* Collar deployment dates
* Collars (including brand and serial number)
* GPS data (raw from the collars)

## Database structure
Below is a schematic of the structure of my relational database. The next chapter will detail how the database was constructed.

![Schematic of database structure](../docs/database-design.PNG)
